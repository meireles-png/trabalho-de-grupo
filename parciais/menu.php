        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="nova_cobranca.php">Cobranças</a> <!-- Link para a página de cobranças -->
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="cobrancas.php">Pagamentos</a> <!-- Link para a página de pagamentos -->
                    </li>
                    <li class="nav-item">
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="nova_cobranca.php" class="btn btn-primary">Acessar</a> <!-- Botão para acessar a página de cobranças -->
                    </div>
                </div>
            </div>
        </div>
